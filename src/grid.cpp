...
//   bool walkable_feature =
//       non_existant_feature || feature[proposed_x][proposed_y]->walkable;
...
//           walkable_feature); // can move with to place with no
...
//   Dir random_proposed{static_cast<int>(mt())}; // empty constructor makes it
//                                                // generate randomly
