...
public:
  ...
  void random_walk();
  void destructive_walk(int x, int y, Terrain* (*terrain)[SIZE][SIZE], int iterations); //2d array of pointers to entities
  void creative_walk_fauna(int x, int y, Feature* (*feature)[SIZE][SIZE], int iterations); //2d array of pointers to entities

  void creative_walk_walls(int x, int y, Terrain* (*terrain)[SIZE][SIZE], int iterations); //2d array of pointers to entities
